...
old_logic = """       const processGameEnd = async (winnerId: string) => {
...
new_logic = """       const processGameEnd = async (winnerId: string) => {
...
if old_logic in content:
    ...
    with open('src/pages/GameBoard.tsx', 'w') as f:
        f.write(content)
    print("Replaced processGameEnd!")
else:
    print("Could not find old_logic for processGameEnd")
